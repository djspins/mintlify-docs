...
Users text Coco to complete actions on their behalf and also frequently login to their Dashboard to see all their reminders, lists, contacts, and more.

🎙️ Coco understands voice notes in multiple languages

🌉 Coco can analyze images you send in great detail
<Tip>
  🎬 (image of a movie screening)
  Coco, add this to my calendar
</Tip>
...
- Ask Coco for a login link and click the `Login` button
